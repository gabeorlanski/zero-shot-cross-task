...
python experiment.py +run_name="LenNorm" task=cb +split=validation \
  model_name="bigscience/T0_3B" \
  evaluation.length_normalization=True
python experiment.py +run_name="LenNorm" task=anli +split=dev_r1 \
  model_name="bigscience/T0_3B" \
  evaluation.length_normalization=True
python experiment.py +run_name="LenNorm" task=anli +split=dev_r2 \
  model_name="bigscience/T0_3B" \
  evaluation.length_normalization=True
python experiment.py +run_name="LenNorm" task=anli +split=dev_r3 \
  model_name="bigscience/T0_3B" \
  evaluation.length_normalization=True
python experiment.py +run_name="LenNorm" task=rte +split=validation \
  model_name="bigscience/T0_3B" \
  evaluation.length_normalization=True
python experiment.py +run_name="LenNorm" task=wsc +split=validation \
  model_name="bigscience/T0_3B" \
  evaluation.length_normalization=True
python experiment.py +run_name="LenNorm" task="wsc.fixed" +split=validation\
   model_name="bigscience/T0_3B" \
   evaluation.length_normalization=True
python experiment.py +run_name="LenNorm" task=wic +split=validation \
  model_name="bigscience/T0_3B" \
  evaluation.length_normalization=True
