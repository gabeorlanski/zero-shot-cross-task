...
python experiment.py +run_name="T0" task="wsc_fixed" +split=validation model_name="bigscience/T0_3B"
...
python experiment.py +run_name="T5" task=wsc +split=validation model_name="t5-3b" \
  batch_size=1
python experiment.py +run_name="T5" task="wsc_fixed" +split=validation model_name="t5-3b" \
  batch_size=1
